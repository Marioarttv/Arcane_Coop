namespace Arcane_Coop.Models
{
    ...
    public class Act1MultiplayerGame
    {
        ...
        public List<string> StoryProgression { get; set; } = new() { "emergency_briefing", "picture_explanation_transition", "database_revelation", "signal_decoder_transition", "radio_decoded" };
